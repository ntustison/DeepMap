...
The major elements of CNNs are localized connections, convolutions, and
subsampling (or "pooling") [@LeCun:2015aa].

An illustration of a bare-bones CNN configuration is provided in Figure \ref{fig:convnet} which depicts
