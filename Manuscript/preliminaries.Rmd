...
* siamese networks [@Bromley:1994aa;@Chopra:2005aa],
...
* CoordConv [@Liu:2018aa], and

* generative adverserial networks [@Goodfellow:2014aa].
...
Zagoruyko et al. discuss multiple architectures, including siamese architectures, for comparing
...
In the case of U-net, the decoder subnetwork mirrors its encoder analog
