...
\multicolumn{5}{c}{\textbf{Two channel}}
  \vspace{0.25cm} \\
  DeTone et al. [79] & 2016 & 2-D & Homography & MSQ$_T$ \\ % The loss is trained on the msq difference between the true and predicted displacement vectors
  Nguyen et al. [80] & 2018 & 2-D & Homography & L1, MSQ$_T$ \\ % L1 on unsupervised, MSQ$_T$ on supervised
  Rohe et al. [81] & 2017 & 3-D & Diffeomorphic & MSQ$_T$ \\  % The loss is trained on the msq difference between the true and predicted SVF parameterization
  Eppenhof et al. [82] & 2018 & 3-D & TPS & MSQ$_T$ \\       % The loss is trained on the msq difference between the true and predicted displacements
...
\multicolumn{5}{c}{\textbf{Siamese/pseudo-siamese}}
  \vspace{0.25cm} \\
  Dosovitskiy et al. [89] & 2015 & 2-D & Optical flow & MSQ$_T$ \\ % The loss is trained on the msq difference between the true and predicted displacement vectors
  Nowruzi et al. [100] & 2017 & 2-D & Homography & MSQ$_T$ \\
  Rocco et al. [101] & 2017 & 2-D & Affine + TPS & MSQ$_T$ \\
  Sloan et al. [102] & 2018 & 2-D & Rigid & MSQ$_T$ \\  % The loss is trained on the msq difference between the true and predicted transformation parameters
  Sokooti et al. [103] & 2017 & 3-D & Deformable & L1$_T$ \\
  Zhang [104] & 2018 & 3-D & IC Deformable & MSQ + ER \\
  Yang et al. [112] & 2018 & 3-D & Diffeomorphic & L1$_T$ \\  % The loss is the 1-norm between the predicted and desired momentum
\midrule
