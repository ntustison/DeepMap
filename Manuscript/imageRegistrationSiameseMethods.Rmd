...
An early seminal paper described _FlowNet_, a 2-D CNN-based approach to
optical flow optimization [@Dosovitskiy:2015aa].  Two encoding/decoding
architectures are actually proposed for comparison for real world RGB
...
series of contracting convolutional layers.  The pseudo-siamese _FlowNetCorr_
...
using a correlation layer.
Although the simple variant reportedly
...
involves the addition literal flying chairs to existing
image scenes.
...
_ICNet_  [@Zhang:2017aa]  is motivated by traditional concerns of inverse
