...
the process of establishing spatial correspondence
...
\textcolor{blue}{
Deep learning also provides opportunities for new perspectives such as
training on loss functions which penalize deviations from the ``true'' transformations
