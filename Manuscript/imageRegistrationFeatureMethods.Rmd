...
between spatial domains.  For example, at the start of the
current era of deep learning in image-related research, the authors of [@Sergeev:2012aa]
...
Similarly, _DeepFlow_ [@Weinzaepfel:2013aa] uses CNNs to detect
...
Finally, in the category of feature learning, Wu et al. use nested auto-encoders (AE)
to map patchwise image content to learned feature vectors [@Wu:2016aa].  These
...
such as edges. The AE-based feature vectors at these image patches are then
