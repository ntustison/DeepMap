...
A given STN comprises three principal components:  1) a localization network,
...
[@Jaderberg:2015aa], discussion was limited to
affine, attention (scaling + translation), and thin-plate spline transforms which are
fill the requirements of differentiability.  This
was later extended to encompass a diffeomorphic transformer network (DTN) [@Detlefsen:2018aa]
based on [@Freifeld:2017aa]
